        ...
        return(
            ...
            >
                ...
                <View style={{height:100, flexDirection:'row'}}>
                    ...
                    >
                        <Text style={{textDecorationLine:'underline', fontWeight:'600'}}>INCREMENT</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={()=>decrementAction()}
                        style={{flex:1, justifyContent:'center', alignItems:'center'}}
                    >
                        <Text style={{textDecorationLine:'underline', fontWeight:'600'}}>DECREMENT</Text>
                    </TouchableOpacity>
                </View>
                <TouchableOpacity
                    style={{paddingVertical:15, paddingHorizontal:40,  backgroundColor:'indigo'}}
                    onPress={this.navigate}
                >
                    <Text style={{fontSize:23, fontWeight:'600', color:'white'}}>Screen2</Text>
                </TouchableOpacity>
            </View>
        )
    }
